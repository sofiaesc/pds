...
# Añado ruido a la mezcla para probar robustez
ruido_blanco = np.random.normal(0,0.03,len(comb))
...
fig.tight_layout()
plt.savefig('plots/ruido/señales_originales.png')
...
fig.tight_layout()
plt.savefig('plots/ruido/espectrogramas_originales.png')
...
plt.savefig('plots/ruido/error.png')
...
fig.tight_layout()
plt.savefig('plots/ruido/espectrogramas_comparacion1.png')
...
fig.tight_layout()
plt.savefig('plots/ruido/señales_comparacion1.png')

# Guardo resultado en un archivo de audio .wav:
soundfile.write(f'resultados/ruido/instrumento1.wav',rec_i1,sr)
soundfile.write(f'resultados/ruido/instrumento2.wav',rec_i2,sr)